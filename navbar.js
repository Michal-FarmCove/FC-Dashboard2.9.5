    ...
    const navbarHTML = `
        <aside class="sidebar">
            <div class="logo-section">
                <img src="Farm Cove Logo with text White & hero colour.png" alt="Farm Cove Logo" class="logo-image">
...
function highlightActiveButton() {
    ...
    const dropdownPages = {
        ...
        "Setup": ["bfi.html", "compliance-documents.html", "bfi-films-set-in-the-uk.html", "bfi-films-set-in-the-uk2.html", "bfi-pdf.html", "bfi-draft-manage.html", "bfi-synopsis.html", "compliance-documents-details.html", "compliance-documents-details-gen.html", "compliance-documents-details-sent.html"],
        "Reporting": ["reports.html", "transactions.html"]
    };
